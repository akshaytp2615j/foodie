...
const NGOSignUpPage = () => {
  ...
  const { registerNGO, authState, error, setError } = authContext;
      ...
      <div className="auth-card">
        <div style={{ textAlign: "center", marginBottom: "30px" }}>
          <h2 style={{ fontSize: "2rem", fontWeight: 800 }}>
            Register your <span style={{ color: "#f59e0b" }}>NGO</span> with Foodie
          </h2>
          <p style={{ color: "#6b7280", marginTop: "5px" }}>
            Get access to surplus food donations from restaurants near you.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="form-group">
            <label className="form-label" htmlFor="ngo-name">
              NGO Name
            </label>
            <input
              id="ngo-name"
          ...
          <div className="form-group">
            <label className="form-label" htmlFor="ngo-id">
              NGO Registration ID
            </label>
            <input
              id="ngo-id"
            ...
            <p style={{ fontSize: "0.75rem", color: "#6b7280", marginTop: "4px" }}>
              e.g., Trust/Society Registration No., 12A, 80G.
            </p>
          </div>
          ...
          <button
            ...
            disabled={submitting}
          >
            {submitting ? "Registering NGO..." : "Register Your NGO"}
          </button>
        </form>
